    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_path', models.CharField(blank=True, default=None, max_length=300, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sort_title', models.CharField(default=models.CharField(max_length=300), max_length=300)),
                ...
                ('letterboxd_url_slug', models.CharField(blank=True, max_length=300, null=True)),
                ('characters', models.ManyToManyField(blank=True, to='movies.character')),
                ('directors', models.ManyToManyField(blank=True, to='movies.director')),
                ('formats', models.ManyToManyField(blank=True, to='movies.format')),
            ],
            options={
                'ordering': ['sort_title'],
            },
